...
if __name__ == '__main__':
    ...
    args.add_argument('-c', '--config', default="model/PICK/config.json", type=str,
    ...
    options = [
        ...
        CustomArgs(['--bs', '--batch_size'], default=8, type=int, target='train_data_loader;args;batch_size',
